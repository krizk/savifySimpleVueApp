      ...
      budgets: [
        {
          ...
          transactions: [
            {
              description:
                "APPLE PAY - SENT M 01-31 877-233-8552 CA 1269 DEBIT CARD PURCHASE",
              amount: 2031
            },
            {
              description:
        ...
        },
        {
          ...
          transactions: [
            {
              description:
                "Netflix.com 02-26 netflix.com CA 3284 DEBIT CARD RECURRING PYMT",
              amount: 1099
            },
            {
